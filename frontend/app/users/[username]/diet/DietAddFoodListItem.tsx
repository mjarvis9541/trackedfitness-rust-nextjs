...
import { dietAddFood } from "@/app/actions";
...
export default function DietAddFoodListItem({
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    const data = await dietAddFood({
      date,
      username,
      meal_of_day_id: meal.id,
      food_id: food.id,
  ...
  return (
    <>
      <form className="group contents" action={handleSubmit}>
        ...
        <div className="flex items-center justify-end border-b-[1px] group-hover:bg-amber-200">
